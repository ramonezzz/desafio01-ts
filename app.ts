...
const personAccount : PeopleAccount =  new PeopleAccount(71182204180, 'Ramon', 10, true)
...
const companyloan : CompanyAccount = new CompanyAccount('DeathStar Enterprises', 100, false)
console.log(`${companyloan.getName()} - ${companyloan.getAccountNumber()}`)
companyloan.getLoan(100)

const farmAccount : agroAccount = new agroAccount("Fazenda Tatooine", 225, true)
